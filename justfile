...
fuzz time="10s":
    go test -run '^$' -fuzz='^FuzzParseTCPHeader$' -fuzztime={{time}} ./tcp/transport/
    go test -run '^$' -fuzz='^FuzzParseTCPOptions$' -fuzztime={{time}} ./tcp/transport/
    go test -run '^$' -fuzz='^FuzzParseIPv4Header$' -fuzztime={{time}} ./tcp/transport/
